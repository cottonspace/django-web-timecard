...
from worktime.utils import (delta, display_name, get_first_day_of_year,
                            get_users, get_year_range, minutes_to_hours)
...
class TestDateTimeUtils(TestCase):
    ...
    def test_minutes_to_hours(self):
        self.assertEqual(
            minutes_to_hours(0, '0.1', ROUND_CEILING),
            Decimal('0.0')
        )
        self.assertEqual(
            minutes_to_hours(30, '0.1', ROUND_CEILING),
            Decimal('0.5')
        )
        self.assertEqual(
            minutes_to_hours(60, '0.1', ROUND_CEILING),
            Decimal('1.0')
        )
