...
```
- You can easily create a local_settings.py file using the [django-web-timecard easy config tool](https://cottonspace.github.io/docs/tools/django-web-timecard-local-settings.html).
